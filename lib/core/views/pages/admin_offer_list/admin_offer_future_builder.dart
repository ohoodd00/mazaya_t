...
import 'package:mazaya/core/views/pages/admin_offer_list/admin_custom_offer.dart';

class AdminOfferFutureBuilder extends StatelessWidget {
  final List<OfferModel> newOffferModel;
  final String userName;
  final List<UserModel> users;
  const AdminOfferFutureBuilder({
    super.key,
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: OfferVm.get(OfferConstants.tableName),
