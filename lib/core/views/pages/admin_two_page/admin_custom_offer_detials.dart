...
class AdminTwoCustomOfferDetials extends StatelessWidget {
  static String id = "AdminTwoCustomOfferDetials";
  final OfferModel? newOffferModel;
  final OfferModel? offerModel;
  final List<UserModel>? users;
  const AdminTwoCustomOfferDetials(
                                      ...
                                      if (UserVm.userRead() == "admin2") {
                                        ...
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(const SnackBar(
                                                ...
                                                content: Text(
                                                    "لايمتلك مسؤول النظام صلاحيات الرفض")));
                                      }
                                    },
                                    child: const Text("رفض")),
                                ElevatedButton(
                                        ...
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(const SnackBar(
                                                ...
                                                behavior:
                                                    SnackBarBehavior.floating,
                                                content: Text(
                                                    "لايمتلك مسؤول النظام صلاحيات التعديل")));
                                      }
                                    },
                                ...
                                ElevatedButton(
                                    ...
                                    onPressed: () {
                                      if (UserVm.userRead() == "admin1") {
                                        ...
                                        OfferVm.add(OfferConstants.newtableName,
                                            offerModel!);
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(const SnackBar(
                                                margin: EdgeInsets.all(16),
